...
variable "vpc_endpoints_sg_id" {
  description = "SG ID of VPC Endpoints (for SSM outbound). Empty string if not present."
  type        = string
  default     = ""
}
...
variable "domain_name" {
  description = "Base domain name for the environment (e.g., rvdevops.com)"
  type        = string
}
...
variable "certificate_domain" {
  type        = string
  description = "Custom domain for the certificate (e.g., *.rvdevops.com). Leave null to use default wildcard."
  default     = null
}
...
variable "skip_final_snapshot" {
  description = "Skip final snapshot on RDS destruction (recommended: false for Prod)"
  type        = bool
  default     = false
}
